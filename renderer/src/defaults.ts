...
export const defaultActivitySpec: ActivityRenderSpec = {
  ...
  background: null,
  summary: {distanceKm: 42.6, elevationGainM: 620, sourceDurationSeconds: 7200, sourcePointCount: 4, renderPointCount: 4, speedWindowSeconds: 180, maximumGradePct: 7.4},
  points: [
